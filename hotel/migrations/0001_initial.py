    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(choices=[('Indian Best Food', 'Indian Best Food'), ('South Indian Best Food', 'South Indian Best Food'), ('Gujrati Best Food', 'Gujrati Best Food'), ('Punjabi Best Food', 'Punjabi Best Food'), ('Fast Food', 'Fast Food')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
                ...
                ('role', models.CharField(choices=[('Manager', 'Manager'), ('Chef', 'Chef'), ('Delivery Boy', 'Delivery Boy')], max_length=30)),
